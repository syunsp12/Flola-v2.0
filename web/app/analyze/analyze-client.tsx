...
export function AnalyzeClient({
    ...
    const [assetHistory, setAssetHistory] = useState<any[]>(initialAssetHistory)
    const [salaryHistory, setSalaryHistory] = useState<any[]>(initialSalaryHistory)
